...
class App3TypographyData extends BaseTokenParser<FAppTypography, TextStyle> {
  static const colors = App3ColorData();
  static Color defaulColor() => colors.getByToken(FAppColor.gray1);

  final sizes = const App3SizeData();
  @override
  ...
  const App3TypographyData([super.newData]);
  factory App3TypographyData.fromMap(Map<String, dynamic> json) {
    return const App3TypographyData({});
  }
